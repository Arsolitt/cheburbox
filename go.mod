module github.com/Arsolitt/cheburbox

go 1.26.4

require (
	github.com/Arsolitt/amnezigo v0.0.0-20260705152627-d27e8af03f06
	github.com/gofrs/uuid/v5 v5.4.0
	github.com/google/go-jsonnet v0.22.0
	github.com/sagernet/sing v0.8.11
	github.com/sagernet/sing-box v1.13.14-extended-2.5.0
...
// sing-box-extended fork: module path is unchanged (github.com/sagernet/sing-box),
// so the main module must redirect it to the shtorm-7 repo. Go does not honor a
// dependency's own replace directives, so all transitive extended forks must be
// mirrored here verbatim from the fork's go.mod.
