...
// AmneziaConfig holds AmneziaWG obfuscation preferences. Only Protocol and MTU
// are user-facing; the actual Jc/S1/H1/I1 parameters are generated by amnezigo
// and persisted in config.json so they stay stable across runs.
type AmneziaConfig struct {
	Protocol string `json:"protocol,omitempty"` // quic|dns|dtls|stun|sip; default quic
